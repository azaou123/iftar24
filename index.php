...
<head>
    ...
    <link rel="stylesheet" href="https://unpkg.com/bs-brain@2.0.3/components/clients/client-2/assets/css/client-2.css">
</head>
...
<body>
                    ...
                    <div class="banner_text">
                        <div class="banner_text_iner">
                            ...
                            <p>Replenish seasons may male hath fruit beast were seas saw you arrie said man beast whales
                                ...
                                man</p>
                            <a href="inscription.php" class="btn_1">S'inscrire</a>
                            <a href="#" class="btn_2">Badge</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- feature_part start-->
    <section class="feature_part my-">
        <div class="container">
            <h2 class="text-center">Nos <br> Objectifs </h2>
            <div class="row">
                <div class="col-sm-6 col-xl-4">
                    <div class="single_feature">
                        <div class="single_feature_part">
                            <span class="single_feature_icon"><i class="fa-solid fa-handshake-angle"></i></span>
                            <h4>Better Future</h4>
                ...
                <div class="col-sm-6 col-xl-4">
                    <div class="single_feature">
                        <div class="single_feature_part">
                            <span class="single_feature_icon"><i class="fa-solid fa-hands-holding-child"></i></span>
                ...
                <div class="col-sm-6 col-xl-4">
                    <div class="single_feature">
                        <div class="single_feature_part single_feature_part_2">
                            <span class="single_service_icon style_icon"><i class="fa-solid fa-hand-holding-hand"></i></span>
